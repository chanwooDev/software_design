module.exports={
  html:function(title,author,date,image,body,list,comment, create_form,buttonProcess, buttonOption){
    return `
    <!DOCTYPE html>
    <html lang="en">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card my-4">
              ...
              <button type="submit" class="btn btn-primary" onclick="location.href='${buttonProcess}/?id=${title}'">${buttonOption}</button>
            </div>
