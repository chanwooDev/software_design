...
module.exports={
  html:function(location, type, boards, image){
    return `
    <!DOCTYPE html>
    <html lang="en">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            ...
            <div class="list-group">
              ...
              <a href="/circle_main/create?location=${location}&?type=${type}" class="list-group-item">Write post</a>
            </div>
          </div>
          <!-- /.col-lg-3 -->
    ...
    `;
  }, boardPointer:function(title,author,id,description,location,type,image){
    return `
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card h-100">
        <a href="/circle_page?id=${id}&location=${location}&type=${type}"><img class="img-fluid rounded" src="/data/image/${image}" alt="" width="600" height="200"></a>
        <div class="card-body">
          <h4 class="card-title">
