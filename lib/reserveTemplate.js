module.exports={
  html:function(boards, write,type){
    return `
    <!DOCTYPE html>
    <html lang="en">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="/reserv_main?location=reservation">Facility reservation</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            ...
            <div class="list-group">
              ...
              <a href="/reserv_main/create?location=reservation&type=${type}" class="list-group-item">Write post</a>
            </div>
          ...
          <div class="col-lg-9">
            ...
            <div class="row">
            <img class="img-fluid rounded" src="/data/image/none.jpg" alt="">
              </br><br>
              ${boards}
    ...
    <div class="col-lg-4 col-md-6 mb-4">
      <div class="card h-100">
        <a href="/reserv_page?id=${id}&location=${location}><img class="card-img-top" src="http://placehold.it/700x400" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
            <a href="/reserv_page?id=${id}&location=${location}">${title}</a>
          </h4>
