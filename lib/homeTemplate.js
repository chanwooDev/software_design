module.exports={
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card my-4">
              ...
              <button type="submit" class="btn btn-primary" onclick="location.href='/advertisement_create/?location=main'">전체게시판 글쓰기</button>
            </div>
          </div>
  ...
  boardPointer:function(title,author,id,date){
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <a href="/board_page?id=${id}" class="btn btn-primary">Read More &rarr;</a>
      </div>
  ...
  circlesList:function(filelist){
    var list1 = '<div class="col-lg-6"><ul class="list-unstyled mb-0">';
    var list2 = '<div class="col-lg-6"><ul class="list-unstyled mb-0">';
    var i = 0;
    while(i<filelist.length){
      if(i%2 == 0){
        list1 = list1 + `<li><a href="/circles?location=${filelist[i]}"+"소개">${filelist[i]}</a></li>`;
        i=i+1;
      }
      else{
        list2 = list2 + `<li><a href="/circles?location=${filelist[i]}"+"소개">${filelist[i]}</a></li>`;
        i=i+1;
      }
    }
    list1 = list1 + '</ul></div>';
